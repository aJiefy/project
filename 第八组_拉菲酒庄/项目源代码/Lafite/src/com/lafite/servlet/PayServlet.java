...
import com.lafite.util.PaymentUtil;
...
public class PayServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String p0_Cmd = "Buy", p1_MerId = "10001126856", p2_Order = request
				...
				.getParameter("p3_Amt"), p4_Cur = "CNY", p5_Pid = "", p6_Pcat = "", p7_Pdesc = "", p8_Url = "http://localhost:8080/"+request.getContextPath()+"/backServlet", p9_SAF = "", pa_MP = "", pd_FrpId = request
