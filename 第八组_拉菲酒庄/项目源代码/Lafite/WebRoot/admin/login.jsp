				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								...
								<img src="../style/images/lafite.png" style="height: 120px;">
								</div>
								<p class="lead">Administrator Login</p>
							</div>
							<form class="form-auth-small" action="../rootServlet?cmd=login" method="post">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Lafite Backend Login</h1>
