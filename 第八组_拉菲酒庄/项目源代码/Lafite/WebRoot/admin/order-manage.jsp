...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/assets/vendor/font-awesome/css/font-awesome.min.css">
	...
	<link rel="icon" type="image/png" sizes="96x96" href="${pageContext.request.contextPath}/admin/assets/img/favicon.png">
</head>
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.jsp"><img src="${pageContext.request.contextPath}/admin/assets/img/logo-dark.png" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="./admin/index.jsp" ><i class="lnr lnr-home"></i> <span>主页</span></a></li>
						
						<li><a href="./WineServlet?tag=list"><i class="fa fa-glass"></i> <span>Lafite管理</span></a></li>
						<li><a href="./orderServlet?cmd=list" class="active" ><i class="fa fa-list-alt"></i> <span>订单管理</span></a></li>
						<li><a href="./userServlet?cmd=list" ><i class="lnr lnr-users"></i> <span>客户管理</span></a></li>
						<!-- <li><a href="register.jsp" ><i class="lnr lnr-pencil"></i> <span>管理员注册</span></a></li> -->
						<li><a href="./index.jsp" ><i class="lnr lnr-exit"></i> <span>退出系统</span></a></li>
	...
	<script src="${pageContext.request.contextPath}/admin/assets/vendor/jquery-slimscroll/jquery.slimscroll.min.js"></script>
	<script src="${pageContext.request.contextPath}/admin/assets/vendor/toastr/toastr.min.js"></script>
