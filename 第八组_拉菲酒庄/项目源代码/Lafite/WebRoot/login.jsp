                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="userServlet?cmd=login" method="post" class="login-form">
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<input type="text" name="form-code" required="required" placeholder="identifying code..." class="form-code form-control" id="form-code">
			                        </div>
			                          <div class="form-group">
